...
#define COUNT1_VAL 120000   // IR timeout 5 сек
#define COUNT2_VAL 5        // IR timeout 5 сек
...
void loop() {
  if (Serial.available() > 0) {
    ...
    flag_timeout = 1;
    for (count1=0; count1 < COUNT1_VAL; count1++) {   // 5 sec timeout
    for (count2=0; count2 < COUNT2_VAL; count2++) {
      if (digitalRead(IR_barrier_signal_pin) == 1 ) {
        count1 = COUNT1_VAL;
        count2 = COUNT2_VAL; 
        flag_timeout = 0;
      }
