...
while True:
    for line in ser.read():   # ans from driver Serial Port
        ...
        requests.post('http://178.140.18.140:3141/cell', data={"status":"", "num":a, "clientID":1})  # ans - successful issue
    ...
    try:
        ...
        if 0 < cell < 65:
            ...
            #requests.post('http://178.140.18.140:3141/cell', data={"status":"", "num":a, "clientID":1})  //for test   ans - successful issue
    except:
        print("not number")
